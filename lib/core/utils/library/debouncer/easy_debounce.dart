...
/// A void callback, i.e. (){}, so we don't need to import e.g. `dart.pages`
...
class EasyDebounce {
  ...
  static void cancelAll() {
    for (final _EasyDebounceOperation operation in _operations.values) {
